...
import { links, reviews1 } from "../utils/constants"
...
const IndianMethod = () => {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div id="indian-method" className="appx flex flex-col items-center">
        <h3
          data-aos="fade-in"
        ...
        <ScrollLink to="pricing" scrollOn={"/welcome"} className="brand-btn">
